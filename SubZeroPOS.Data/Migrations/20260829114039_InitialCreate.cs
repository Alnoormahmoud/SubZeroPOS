        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEn = table.Column<string>(type: "varchar(100)", unicode: false, maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InvoiceFooterPrimary = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    InvoiceFooterSecondary = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
                    CurrencyCode = table.Column<string>(type: "varchar(10)", unicode: false, maxLength: 10, nullable: false, defaultValue: "SDG"),
                    CurrencySymbol = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false, defaultValue: "ج.س"),
                    DateFormat = table.Column<string>(type: "varchar(50)", unicode: false, maxLength: 50, nullable: false, defaultValue: "yyyy-MM-dd HH:mm"),
                    ShowCashierNameOnInvoice = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ShowLogoOnInvoice = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ShowOrderNumberOnInvoice = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleNameAr = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusCode = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false, defaultValue: "Completed"),
                    PaymentMethodCode = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: false, defaultValue: "Cash"),
                    TotalAmount = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
                    DeliveryFee = table.Column<decimal>(type: "decimal(10,2)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LineTotal = table.Column<decimal>(type: "decimal(10,2)", nullable: false, computedColumnSql: "([Quantity]*[UnitPrice])", stored: true)
                },
                constraints: table =>
                {
