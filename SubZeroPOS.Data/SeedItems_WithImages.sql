...
/* ============================================================
   PASS 1: Insert items WITHOUT image paths first, so we get
   real ItemId values back from SQL Server (IDENTITY column).
   ============================================================ */
...
/* ============================================================
   PASS 2: Now that every item has a real ItemId, set ImagePath
   to match "Images/Items/{ItemId}.jpg" automatically.
   No need to type out each ID by hand.
   ============================================================ */
UPDATE Items
SET ImagePath = 'Images/Items/' + CAST(ItemId AS NVARCHAR(10)) + '.jpg';
GO

/* ============================================================
   Check the result - this tells you exactly which filename
   to save each photo as.
   ============================================================ */
SELECT ItemId, ItemName, ImagePath FROM Items ORDER BY ItemId;
GO
